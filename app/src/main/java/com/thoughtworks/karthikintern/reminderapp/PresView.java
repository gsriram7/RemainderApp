...
public class PresView extends Activity{
    ...
    //JSON Node Names
    private static final String TAG_MED = "med";
    ...
    private static final String TAG_MED_COURSE = "course";
    ...
    class JSONOffline extends AsyncTask<String, String, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            med_course=(TextView)findViewById(R.id.TXTCourse);
        ...
        protected void onPostExecute(JSONObject json) {
            ...
            try {
                ...
                for(int i = 0; i < android.length(); i++){
                    ...
                    String str_course=c.getString(TAG_MED_COURSE);
                    ...
                    map.put(TAG_MED_COURSE,str_course);
                    ...
                    ListAdapter adapter = new SimpleAdapter(PresView.this, medlist,
                            ...
                            new String[] { TAG_MED_NAME,TAG_MED_START_DATE,TAG_MED_END_DATE,TAG_MED_COURSE,TAG_MED_DESC,TAG_MED_DOSAGE }, new int[] {
